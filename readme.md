...
This document provides a comprehensive guide to understanding the football data and betting odds included in the dataset. The data is primarily in CSV format and can be used with standard spreadsheet applications.
...
- [Instructions Guide](#instructions-guide)
  ...
  - [Overview](#overview)
  - [Sections](#sections)
  - [Football Data Notes](#football-data-notes)
  - [Key to Results Data](#key-to-results-data)
  - [Match Statistics](#match-statistics)
  - [Pre-closing Odds](#pre-closing-odds)
  - [Key to 1X2 Betting Odds Data](#key-to-1x2-betting-odds-data)
  - [Key to Total Goals Betting Odds](#key-to-total-goals-betting-odds)
  - [Key to Asian Handicap Betting Odds](#key-to-asian-handicap-betting-odds)
  - [Closing Odds](#closing-odds)
  - [Acknowledgements](#acknowledgements)

## Football Data Notes

All data is in CSV format, ready for use within standard spreadsheet applications. Some abbreviations may refer to data collected in earlier seasons. For a current list of included bookmakers, visit [Football Data](http://www.football-data.co.uk/matches.php).
...
For closing odds, see the section on [Closing Odds](#closing-odds).

## Key to 1X2 Betting Odds Data
...
- **Current results (full time, half time)**: [XScores](http://www.xscores.com)
